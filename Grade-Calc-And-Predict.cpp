...
//Class called 'Logger' which inherites the functions from 'FileInputOutput' class. Has functions 
//					to log different types of situations, like error, start, data change, etc.
class Logger : private FileInputOutput
{
private:
